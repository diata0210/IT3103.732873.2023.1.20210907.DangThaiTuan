...
public class LinearSystemSolver {
  public static void main(String[] args) {
    ...
    String strA11 = JOptionPane.showInputDialog(null, "Tuan.DT210907: Please input a11: ",
        "Tuan.DT210907: Input the first number", JOptionPane.INFORMATION_MESSAGE); // nhập chuỗi a11
    String strA12 = JOptionPane.showInputDialog(null, "Tuan.DT210907: Please input a12: ",
        "Tuan.DT210907: Input the second number", JOptionPane.INFORMATION_MESSAGE); // nhập chuỗi a12
    String strB1 = JOptionPane.showInputDialog(null, "Tuan.DT210907: Please input b1: ",
        "Tuan.DT210907: Input the second number", JOptionPane.INFORMATION_MESSAGE); // nhập chuỗi b1
    // a21*x1+a22*x2=b2
    String strA21 = JOptionPane.showInputDialog(null, "Tuan.DT210907: Please input a21: ",
        "Tuan.DT210907: Input the first number", JOptionPane.INFORMATION_MESSAGE); // Nhập chuỗi a21
    String strA22 = JOptionPane.showInputDialog(null, "Tuan.DT210907: Please input a22: ",
        "Tuan.DT210907: Input the second number", JOptionPane.INFORMATION_MESSAGE); // Nhập chuỗi a22
    String strB2 = JOptionPane.showInputDialog(null, "Tuan.DT210907: Please input b2: ",
        "Tuan.DT210907: Input the second number", JOptionPane.INFORMATION_MESSAGE); // Nhập chuỗi b2
    ...
    double x1 = D1 / D;
    double x2 = D2 / D;
    String formattedResultX1 = decimalFormat.format(x1);     // format lại giá trị của x1
    String formattedResultX2 = decimalFormat.format(x2);     // format lại giá trị của x2
    JOptionPane.showMessageDialog(null, "Tuan.DT210907: Solution:\nx1 = " + formattedResultX1 + "\nx2 = " + formattedResultX2,
        "Tuan.DT210907: Result", JOptionPane.INFORMATION_MESSAGE); // ra thông báo về nghiệm
  }
}
